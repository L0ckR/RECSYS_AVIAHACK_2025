...
class RecommendationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetRecommendations = channel.unary_unary(
                '/psb.recommendation.v1.RecommendationService/GetRecommendations',
        ...
        self.SendFeedback = channel.unary_unary(
                '/psb.recommendation.v1.RecommendationService/SendFeedback',
                request_serializer=recommendation__pb2.FeedbackEvent.SerializeToString,
                response_deserializer=recommendation__pb2.FeedbackAck.FromString,
                _registered_method=True)
...
def add_RecommendationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SendFeedback': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=recommendation__pb2.FeedbackEvent.FromString,
                    response_serializer=recommendation__pb2.FeedbackAck.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'psb.recommendation.v1.RecommendationService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('psb.recommendation.v1.RecommendationService', rpc_method_handlers)
...
class RecommendationService(object):
    ...
    def SendFeedback(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/psb.recommendation.v1.RecommendationService/SendFeedback',
            recommendation__pb2.FeedbackEvent.SerializeToString,
            recommendation__pb2.FeedbackAck.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
